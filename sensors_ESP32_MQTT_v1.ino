...
#define mqttTemperatur "dht11/temperature_by_houssam"
#define mqttHumidity "dht11/humidity_by_houssam"
//MQTT Setup End
...
float temp1, temp2, temperature, hum1, hum2, humidity;
...
void loop() {
  ...
  client.publish(mqttTemperatur, String(temperature).c_str(),true);
